...
author: "SSP/DEMESIS"
description: |
  Support de formation de Git pour les utilisateurs de R au MASAA
...
Ce diaporama de formation a été rédigé dans le but d'être le support visuel des formations dispensées au [MASAA](https://agreste.agriculture.gouv.fr/).  
...
De même, il est orienté pour être utile aux agents du SSM MASAA et se concentre donc sur une utilisation de R via [RStudio](https://posit.co/download/rstudio-desktop/) qui est mise à disposition des agents sur la plateforme interne Cerise basée sur RStudio Workbench.  
...
Enfin, en tant que forge interne du MASAA, les fonctionnalités principales de [Gitlab](https://about.gitlab.com/) sont présentées dans ce support. Même si la majorité des concepts de base sont équivalents, [Github](https://github.com/) n'est pas abordé dans ce diaporama de formation.
:::
