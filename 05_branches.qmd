...
Pour conserver la version distante, j’ai utilisé la commande : git checkout --theirs README.md.
Pour conserver la version locale, j’ai utilisé la commande : git checkout --ours README.md.
git status
git add .
