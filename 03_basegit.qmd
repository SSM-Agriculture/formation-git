...
## Les états des fichiers avec RStudio

![](img/icone_rstudio.png){.inlineimage} [L'onglet de RStudio permet d'avoir des 
...
- `Renamed` : le fichier a été renommé   
- `Untracked` : le fichier a été ajouté au working directory  
...
*Attention lors du renommage d'un fichier, l'état des fichier sera :*  

| AVANT l'ajout à l'index               | APRÈS l'ajout à l'index               |
|---------------------------------------|---------------------------------------|
|![](img/renommer_avant_staging.png)    | ![](img/renommer_apres_staging.png)   |


## Les états des fichiers avec le terminal

![](img/icone_terminal.png){.inlineimage} [La commande `git status` affiche l'état du working directory et de l'index.]{.red}  
<br>
