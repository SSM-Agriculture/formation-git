...
- URL de la forge interne du MASAF : [https://gitlab.forge.agriculture.rie.gouv.fr/gitlab/](https://forge.agriculture.rie.gouv.fr/gitlab/)  
...
Par exemple :  
`git clone https://gitlab.forge.agriculture.rie.gouv.fr/gitlab/damien.dotta/test.git`  
...
Par exemple :  
`git remote add origin https://gitlab.forge.agriculture.rie.gouv.fr/gitlab/damien.dotta/test.git`
...
```r
ajouter_git(
  origin = "https://gitlab.forge.agriculture.rie.gouv.fr/gitlab/damien.dotta/test.git",
  dossier = "~/test/"
)
```
