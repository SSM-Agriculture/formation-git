...
- URL de la forge interne du MASAA : [https://gitlab.forge.agriculture.rie.gouv.fr/](https://gitlab.forge.agriculture.rie.gouv.fr/)  
...
Au MASAA, [une procédure de configuration existe et a été validée en mars 2024](https://orion.agriculture/confluence/pages/viewpage.action?pageId=1068303025) 
...
::: columns
::: {.column width="30%"}
Aperçu des groupes au MASAA/SSP :
:::
...
## Activer les issues sur la forge interne du MASAA ![](img/icone_gitlab.png)

Par défaut, les issues ne sont pas activées à la création d'un dépôt sur la forge Gitlab du MASAA.  
