...
... les boutons de pull/push deviennent disponibles.
...
La fonction relance une nouvelle session R et vous l'onglet "Git" est disponible et opérationnel.
...
Il y a encore pleins d'instructions et de concepts Git très utiles que vous découvrirez (ou pas) :
