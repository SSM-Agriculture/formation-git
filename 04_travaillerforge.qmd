...
## Lier un dépôt local à un dépôt distant avec RStudio (1/4) ![](img/icone_rstudio.png)
...
## Lier un dépôt local à un dépôt distant avec RStudio (2/4) ![](img/icone_rstudio.png)
...
## Lier un dépôt local à un dépôt distant avec RStudio (3/4) ![](img/icone_rstudio.png)
...
## Lier un dépôt local à un dépôt distant avec RStudio (4/4) ![](img/icone_rstudio.png)

<br>

[**CAS 2 : un répertoire existe déjà**]{.souligneRouge}

Dans ce cas, l'interface de RStudio est mal pensé et **il est beaucoup plus intuitif d'utiliser le terminal** (voir [ici](#lier-un-dépôt-local-à-un-dépôt-distant-avec-terminal-22))
...
::: columns
::: {.column width="50%"}
Cliquer sur le bouton "Ajouter à distance" :  
...
- Lier votre projet R à ce dépôt distant (de préférence avec le terminal)  
