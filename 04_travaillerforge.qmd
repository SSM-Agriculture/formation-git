...
- URL de la forge interne du MAASA : [https://gitlab.forge.agriculture.rie.gouv.fr/](https://gitlab.forge.agriculture.rie.gouv.fr/)  
...
Au MAASA, [une procédure de configuration existe et a été validée en mars 2024](https://orion.agriculture/confluence/pages/viewpage.action?pageId=1068303025) 
...
::: columns
::: {.column width="30%"}
Aperçu des groupes au MAASA/SSP :
:::
...
| Rôle | Permissions |
| :--- | :--- |
| **Owner** | Les propriétaires ont un contrôle total sur le projet ou le groupe, y compris la gestion des membres et la suppression. |
| **Maintainer** | Les mainteneurs ont des droits similaires aux propriétaires, mais n'ont pas accès à l'intégralité des paramètres sensibles du projet/groupe. |
| **Developer** | Les développeurs ont des droits d'écriture sur le code, peuvent créer des branches et fusionner des Merge Requests. |
| **Planner** | Les planificateurs se concentrent sur la gestion : ils peuvent gérer les tickets (issues), les tableaux de bord et les jalons, mais n'ont pas accès au code source. |
| **Reporter** | Les rapporteurs ont des droits de lecture sur le projet. Ils peuvent voir le code et créer des tickets, mais ne peuvent pas modifier le dépôt. |
| **Guest** | Les invités ont des droits très limités (lecture seule sur les tickets) et n'ont généralement pas accès au contenu du code source. |
...
## Activer les issues sur la forge interne du MAASA ![](img/icone_gitlab.png)

Par défaut, les issues ne sont pas activées à la création d'un dépôt sur la forge Gitlab du MAASA.  
...
- Sinon, contacter la BAL : assistance.si-stat.sg@agriculture.gouv.fr.
